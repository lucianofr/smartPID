...
- **ControllerCard**: Fixed 280px width, left-justified horizontal row. Alarm strip (5px colored bar at top), tag name + description header with alarm icon and settings button (⚙), mode indicator label (AUTO/MAN/CAS...), PV/SP/CO analog bars. Border color indicates alarm state. No sparklines — trend data shown in TrendChart.
