...
def _body_to_controller(body: ControllerCreate) -> Controller:
    ...
    return Controller(
        ...
        ai_config=AIConfig(
            ...
            sl_band_lo_pct=body.ai_config.sl_band_lo_pct,
            sl_band_hi_pct=body.ai_config.sl_band_hi_pct,
            sl_error_small_pct=body.ai_config.sl_error_small_pct,
            sl_co_ramp_max_pct_min=body.ai_config.sl_co_ramp_max_pct_min,
        ),
...
_NESTED_BUILDERS: dict[str, tuple[type, callable]] = {
    ...
    "ai_config": (AIConfigDTO, lambda dto: AIConfig(
        ...
        sl_band_lo_pct=dto.sl_band_lo_pct, sl_band_hi_pct=dto.sl_band_hi_pct,
        sl_error_small_pct=dto.sl_error_small_pct,
        sl_co_ramp_max_pct_min=dto.sl_co_ramp_max_pct_min,
    )),
}
