    ...
    >
      ...
      {Array.from({ length: thumbCount }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          className="block h-4 w-4 rounded-none border border-border-strong bg-surface transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-strong disabled:pointer-events-none disabled:opacity-50"
        />
      ))}
    </SliderPrimitive.Root>
  );
